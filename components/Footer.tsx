    ...
    <footer className="bg-[#1C3557] text-white mt-24">
      <div className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="md:col-span-1">
          <h3 className="text-lg font-light tracking-[0.2em] mb-4">竹谷商事</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-400">
            ...
            <li><a href="/products?category=30mm+識別テープ" className="hover:text-white transition-colors">30mm 識別テープ</a></li>
            <li><a href="/products?category=15mm+識別テープ" className="hover:text-white transition-colors">15mm 識別テープ</a></li>
            <li><a href="/products?category=厚手・特殊テープ" className="hover:text-white transition-colors">厚手・特殊テープ</a></li>
          </ul>
        </div>
      ...
      <div className="border-t border-[#2A4A72] py-6 text-center text-gray-500 text-xs tracking-wider">
        © {new Date().getFullYear()} 竹谷商事. All rights reserved.
      </div>
    </footer>
  );
}
